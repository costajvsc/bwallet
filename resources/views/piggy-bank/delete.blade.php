...
@section('title') Delete {{$piggy_bank->title}} Piggy Bank @endsection

@section('body')
    <h3 class="mt-2 mb-4"><i class="fas fa-piggy-bank"></i>  Delete Piggy Bank #{{$piggy_bank->id_piggy_bank}}</h3>
